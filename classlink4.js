...
const apps = [
  ...
  { name: 'Buckshot Roulette', url: 'https://cdn.jsdelivr.net/gh/genizy/web-port@main/buckshot-roulette/index.html', icon: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQW0pkA7JfrcIexKwRvSuX4EaJw4n2Gf4r2Sw&s' , status: 'unavailable', statusNote: 'Fixing the game rn' },
  ...
  { name: 'Doom 2', url: 'https://cdn.jsdelivr.net/gh/freebuisness/covers@main/602.png', status: 'unavailable', statusNote: 'Fixing the game rn' },
  ...
  { name: 'Jetpack Joyride', url: 'https://cdn.jsdelivr.net/gh/UncopylockDomainHere/testing/games/jj.html', icon: 'https://cdn.jsdelivr.net/gh/freebuisness/covers@main/7.png' , status: 'unavailable', statusNote: 'Fixing the game rn' },
